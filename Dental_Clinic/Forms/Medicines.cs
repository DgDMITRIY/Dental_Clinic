...
namespace WinFormsApp1
{
    public partial class Medicines : Form
    {
        ...
        private string sPath = "mybd.db"; // изменяйте путь к переменной, если путь к базе данных отличается (сама база данных находится в папке WinFormsApp1 и называется mybd )
